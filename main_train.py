...
import random
import time
from fairness_constraint.train_utils import train_mlp
from fairness_constraint.test_utils import run_test_evaluation_after_training
from fairness_constraint.models import Feedforward
from fairness_constraint.dataloader import get_dataset
from fairness_constraint.config import get_args, update_config
from fairness_constraint.save_utils import ResultsManager
from fairness_constraint.resource_monitor import ResourceMonitor
...
def run_training_only(args, model_type, eps, lmbd, testloader, train_results_dir, test_results_dir, model_dir):
    ...
    try:
        ...
        base_dir = os.path.dirname(train_results_dir)
